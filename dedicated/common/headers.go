...
const (
	...
	sdkName                  = "ibm-kms-cryptounit-go-sdk"
...
func GetXCorrelationIDHeader(headerMap map[string]string) (string, bool) {
	str, ok := headerMap[HeaderNamexCorrelationID]
	return str, ok
}

func GetXRequestIDHeader(headerMap map[string]string) (string, bool) {
	str, ok := headerMap[HeaderNamexRequestID]
	return str, ok
}
